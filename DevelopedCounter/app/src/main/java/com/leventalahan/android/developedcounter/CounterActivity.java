...
public class CounterActivity extends AppCompatActivity {
    ...
    ImageButton play;
    ImageButton stop;
    RadioButton radplayer1;
    RadioButton radplayer2;
    RadioButton radplayer3;
    RadioButton radplayer4;
    RadioButton radplayer5;
    RadioButton radplayer6;
    RadioButton radplayer7;
    RadioButton radplayer8;
    boolean isRunning = false;
    CountDownTimer countDown;
    private long mTimeLeftInMillis = START_TIME_IN_MILLIS;
    private static long START_TIME_IN_MILLIS = 60000;
    TextView itisfun;
    TextView towritecodes;
    TextView gameRule;
    TextView timer;
    TextView quarter;
    TextView teamonelist1;
    TextView teamonelist2;
    TextView teamonelist3;
    TextView teamonelist4;
    TextView teamonelist5;
    TextView teamonelist6;
    TextView teamonelist7;
    TextView teamonelist8;
    String t1p1;
    String t1p2;
    String t1p3;
    String t1p4;
